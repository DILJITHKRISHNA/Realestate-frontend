                ...
                <div className="flex flex-col items-center ml-4 justify-between">
                    <div className="mb-8  gap-2">
                        <Link to='/admin/'>
                            ...
                            <p className="text-white text-sm mt-2 mr-1 hover:text-yellow-200 hover:underline">Dashboard</p>
                        </Link>
                    </div>
                    ...
                    <div className="mb-8  gap-2">
                        <Link to='/admin/Properties'>
                            ...
                            <p className="text-white text-sm mt-2 mr-1 hover:text-yellow-200 hover:underline">Properties</p>
                        </Link>
                    </div>
                    ...
                    <div className="mb-8  gap-2 ">
                        <Link to='/admin/ownerlist'>
                            ...
                            <p className="text-white text-sm mt-2 mr-1 hover:text-yellow-200 hover:underline">Owner List</p>
                        </Link>
                    </div>

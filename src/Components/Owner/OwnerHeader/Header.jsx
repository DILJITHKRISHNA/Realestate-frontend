                ...
                <div className="app">
                    <nav className="bg-black h-auto flex justify-between items-center shadow-md p-2">
                        ...
                        <div className="text-white flex items-center text-md font-semibold leading-6 p-3 flex-wrap sm:text-xl gap-6">
                            ...
                            <Link to="/" className='hover:underline text-white hover:text-yellow-100'>Properties</Link>
                            <Link to="/" className='hover:underline text-white hover:text-yellow-100'>Bookings</Link>
                            <Link to="/" className='hover:underline text-white hover:text-yellow-100'>Enquiry</Link>
                            <Link to="/" className='hover:underline text-white hover:text-yellow-100'>Profile</Link>

                ...
                {loadData.map((data) => (
                    <div className="w-full max-w-[26rem] shadow-lg">
                        <div className="relative">
                            ...
                            <button className="absolute top-4 right-24 rounded-full border-2 shadow-md shadow-black text-white p-2">
                                For Rent
                            </button>
                            <button className="absolute top-4 right-4 rounded-full border-2 shadow-md shadow-green-700 text-white p-2">
                                verified
                            </button>
                        </div>
